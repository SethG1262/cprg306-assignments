...
const ItemList = () => {
  ...
  if (sortBy === 'name') {
    // Sort by name
    sortedItems = [...itemsData].sort((a, b) => a.name.localeCompare(b.name));
  } else if (sortBy === 'category') {
    // Sort by category
    sortedItems = [...itemsData].sort((a, b) => a.category.localeCompare(b.category));
  } else if (sortBy === 'group') {
    // Group items by category and sort
    sortedItems = groupItemsByCategory(itemsData);
  }
